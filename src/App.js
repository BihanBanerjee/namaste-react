...
const jsxHeading = <h1 id="heading" className="head"> Jay Shree Ram 🏹</h1>; // proper valid syntax in jsx. jsxHeading is a valid React element. We don't 
...
const jsxHeadingMultiLines = (<h1 id="heading" className="head"> 
Jay Shree Ram 🏹
</h1>);// If you want to declare a jsx tag in multiple lines then it is recommended use parentheses to wrap it. you can also
